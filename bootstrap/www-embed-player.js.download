...
k.ga=function(a){if(!this.g){a instanceof Rg||(a=new Rg(a));this.Y=a;this.b=a.clone();this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.F,this.b.attrs.id=this.F);this.l.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.F;this.R||(this.R=Lh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=ic(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=ic(Number(a)||
